class DisciplinasController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @disciplina.save
        format.html { redirect_to disciplina_url(@disciplina), notice: "Disciplina criada com sucesso." }
  ...
  def update
    respond_to do |format|
      if @disciplina.update(disciplina_params)
        format.html { redirect_to disciplina_url(@disciplina), notice: "Disciplina editada com sucesso." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to disciplinas_url, notice: "Disciplina excluída com sucesso" }
